...
const About = () => {
  return (
    <section id='about' className='mb-15 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24'>
      ...
      <div>
        <p className='mb-4'>
          For as long as I can remember, I have always had a strong interest in creating something cool. As a result, I would spend my evenings building legos and then later breaking apart old VCR units and broken PCs just to see how they work and then (unfortunately to my dad's dismay) fail to rebuild it.
        </p>
        <p className='mb-4'> 
